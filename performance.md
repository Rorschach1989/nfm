...
|---------------|------------------|------------------|------------------|------------------|------------------|------------------|--------------|
| DeepTM(NPMLE) | 0.661(0.022)     | 0.859(0.025)     | 0.650(0.020)     | 0.677(0.013)     | **0.793(0.010)** | **0.613(0.007)** |              |
...
|               | colon            | whas             | metabric         | gbsg             | flchain          | support          | kkbox        |
|---------------|------------------|------------------|------------------|------------------|------------------|------------------|--------------|
| DeepTM(NPMLE) | **0.182(0.011)** | **0.075(0.009)** | **0.164(0.008)** | **0.176(0.006)** | **0.101(0.004)** | **0.192(0.004)** |              |
...
|               | colon            | whas             | metabric         | gbsg             | flchain          | support          | kkbox        |
|---------------|------------------|------------------|------------------|------------------|------------------|------------------|--------------|
| DeepTM(NPMLE) | **0.534(0.022)** | 0.389(0.062)     | 0.494(0.023)     | 0.522(0.014)     | **0.332(0.011)** | **0.565(0.010)** |              |
